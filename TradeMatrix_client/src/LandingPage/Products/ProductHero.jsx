...
const ProductHero = () => {
  return (
    <header className="w-full mt-8 bg-white">
      <div className="flex gap-5 flex-col justify-center items-center border-b pb-20 border-gray-200 text-center px-6">
        ...
        <p className="flex items-center justify-center text-gray-600 gap-2">
          ...
          <Link
            to="/investments"
            aria-label="Explore investment offerings"
